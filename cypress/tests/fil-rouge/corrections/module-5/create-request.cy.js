/**
 * ============================================================
 * CORRECTION — MODULE 5 : Demander un paiement (Request)
 * ============================================================
 */
...
describe("Demander un paiement (Request)", () => {
  ...
  it("SC58 - devrait envoyer une demande de paiement (Request)", () => {
    ...
    // La page de confirmation affiche "Requested" (pas "Paid")
  ...
  // ──────────────────────────────────────────────
  it("SC59 - devrait voir la demande dans l'onglet Mine", () => {
    cy.login("Heath93", "s3cret");
  ...
  // ──────────────────────────────────────────────
  // SC60 — Accepter une demande de paiement (multi-utilisateur)
  // ──────────────────────────────────────────────
  it("SC60 - devrait accepter une demande de paiement reçue", () => {
