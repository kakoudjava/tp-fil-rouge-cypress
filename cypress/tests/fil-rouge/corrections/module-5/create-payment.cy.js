/**
 * ============================================================
 * CORRECTION — MODULE 5 : Créer un paiement (Payment)
 * ============================================================
 */
...
describe("Créer un paiement", () => {
  ...
  it("SC51 - devrait filtrer les contacts en tapant dans le champ de recherche", () => {
    // On compte le nombre de contacts AVANT de filtrer
    cy.getBySelLike("user-list-item").then(($items) => {
      ...
      // La liste filtrée contient MOINS de résultats qu'avant
      cy.getBySelLike("user-list-item")
        .should("have.length.lessThan", totalAvant)
        .first()
  ...
  it("SC52 - devrait effectuer un paiement de 50$ à Arvilla_Hegmann", () => {
    ...
    // La page de confirmation affiche "Paid $50.00 for..." et les boutons de navigation
  ...
  // ──────────────────────────────────────────────
  // SC53 — Vérifier que le solde diminue
  // ──────────────────────────────────────────────
  ...
  // ──────────────────────────────────────────────
  // SC54 — Bouton Pay disabled si montant vide
  // ──────────────────────────────────────────────
  ...
  // ──────────────────────────────────────────────
  // SC56 — Créer un autre paiement
  // ──────────────────────────────────────────────
  it("SC56 - devrait pouvoir créer un autre paiement via 'Create Another Transaction'", () => {
    // Premier paiement
    cy.getBySelLike("user-list-item").first().click();
    cy.get("#amount").type("10");
    ...
    // Vérifier le succès → la page de confirmation s'affiche
    cy.contains("Paid").should("be.visible");
  });
