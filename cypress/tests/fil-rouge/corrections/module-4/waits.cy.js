/**
 * ============================================================
 * CORRECTION — MODULE 4 : Timeouts et Temps d'attente
 * ============================================================
 */
...
describe("Gestion des temps d'attente", () => {
  ...
  // ──────────────────────────────────────────────
  // SC64 — Intercepter un GET et vérifier la réponse
  // ──────────────────────────────────────────────
  it("SC64 - devrait intercepter le chargement des transactions", () => {
    // cy.intercept() "écoute" les requêtes réseau du navigateur
    // 'GET' = la méthode HTTP
    // '/transactions*' = l'URL (le * signifie "n'importe quoi après")
    // .as('getTransactions') = on donne un nom (alias) à cette interception
    cy.intercept("GET", "/transactions*").as("getTransactions");

    // Le login déclenche le chargement des transactions
    cy.login("Heath93", "s3cret");
  ...
  // ──────────────────────────────────────────────
  // SC65 — Intercepter un POST
  // ──────────────────────────────────────────────
  it("SC65 - devrait intercepter la création d'une transaction et vérifier le body", () => {
  ...
  // ──────────────────────────────────────────────
  // SC66 — Intercepter le login
  // ──────────────────────────────────────────────
  it("SC66 - devrait intercepter le login et vérifier le user ID dans la réponse", () => {
